...
// default gas limit to use if not passed in TransactionArgs
var defaultGasLimit = uint64(4712384)

// default gas price to use if not passed in TransactionArgs
...
func (q *QuorumControlsAPI) AddOrg(orgId string, url string, acct common.Address, txa ethapi.TransactionArgs) (string, error) {
...
func (q *QuorumControlsAPI) AddSubOrg(porgId, orgId string, url string, txa ethapi.TransactionArgs) (string, error) {
	orgService, err := q.permCtrl.NewPermissionOrgService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) ApproveOrg(orgId string, url string, acct common.Address, txa ethapi.TransactionArgs) (string, error) {
	orgService, err := q.permCtrl.NewPermissionOrgService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) UpdateOrgStatus(orgId string, status uint8, txa ethapi.TransactionArgs) (string, error) {
	orgService, err := q.permCtrl.NewPermissionOrgService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) AddNode(orgId string, url string, txa ethapi.TransactionArgs) (string, error) {
...
func (q *QuorumControlsAPI) UpdateNodeStatus(orgId string, url string, action uint8, txa ethapi.TransactionArgs) (string, error) {
	nodeService, err := q.permCtrl.NewPermissionNodeService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) ApproveOrgStatus(orgId string, status uint8, txa ethapi.TransactionArgs) (string, error) {
	orgService, err := q.permCtrl.NewPermissionOrgService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) AssignAdminRole(orgId string, acct common.Address, roleId string, txa ethapi.TransactionArgs) (string, error) {
...
func (q *QuorumControlsAPI) ApproveAdminRole(orgId string, acct common.Address, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) AddNewRole(orgId string, roleId string, access uint8, isVoter bool, isAdmin bool, txa ethapi.TransactionArgs) (string, error) {
...
func (q *QuorumControlsAPI) RemoveRole(orgId string, roleId string, txa ethapi.TransactionArgs) (string, error) {
	roleService, err := q.permCtrl.NewPermissionRoleService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) AddAccountToOrg(acct common.Address, orgId string, roleId string, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) ChangeAccountRole(acct common.Address, orgId string, roleId string, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) UpdateAccountStatus(orgId string, acct common.Address, status uint8, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) RecoverBlackListedNode(orgId string, enodeId string, txa ethapi.TransactionArgs) (string, error) {
	nodeService, err := q.permCtrl.NewPermissionNodeService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) ApproveBlackListedNodeRecovery(orgId string, enodeId string, txa ethapi.TransactionArgs) (string, error) {
	nodeService, err := q.permCtrl.NewPermissionNodeService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) RecoverBlackListedAccount(orgId string, acctId common.Address, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) ApproveBlackListedAccountRecovery(orgId string, acctId common.Address, txa ethapi.TransactionArgs) (string, error) {
	accountService, err := q.permCtrl.NewPermissionAccountService(txa)
	if err != nil {
		return "", err
	}
...
func (q *QuorumControlsAPI) TransactionAllowed(txa ethapi.TransactionArgs) bool {
...
func (q *QuorumControlsAPI) valNodeDetails(url string) error {
	...
	if len(url) != 0 {
		...
		if q.checkNodeExists(url, enodeDet.ID().String()) {
